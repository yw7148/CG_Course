...
var lookat_y = 0;
var lookat_z = 2;
function fn_lookatset()
{
    lookat_x = document.getElementById('lookat_x').value;
    lookat_y = document.getElementById('lookat_y').value;
    lookat_z = document.getElementById('lookat_z').value;
}

var background_r_value = 0.0;
var background_g_value = 0.0;
var background_b_value = 0.0;
function renderScene() {
	
	// fn_make_clear_stencil();
	
    gl.clearColor(background_r_value, background_g_value, background_b_value, 1.0);
	...
	mat4.lookAt(vMat, [lookat_x,lookat_y,lookat_z], [0.0,0.0,0.0], [0,1,0]);
